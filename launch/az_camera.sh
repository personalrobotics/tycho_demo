...
az_launcher "azcam_front" "roslaunch tycho_demo_ros driver_azcam.launch sensor_sn:=001059614112 camera_name:=azcam_front wired_sync_mode:=0 subordinate_delay_off_master_usec:=0 fps:=30 color_resolution:=720P --wait"
...
# az_launcher "azcam_front" "roslaunch tycho_demo_ros driver_azcam.launch sensor_sn:=000704321512 camera_name:=azcam_front wired_sync_mode:=0 subordinate_delay_off_master_usec:=0 fps:=30 color_resolution:=1080P --wait"
# launcher "azcam_undistort_front" "ROS_NAMESPACE=azcam_front roslaunch tycho_demo_ros az_camera.launch camera:=azcam_front --wait"