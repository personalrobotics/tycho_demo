...
# 4. camera
#pr_ros_launcher "realsense" "hebi_demo" "realsense-camera.launch"
launcher "rs_camera_435" "roslaunch hebi_demo realsense-camera.launch serial_no:=832112070487 camera:=435 --wait"
launcher "rs_camera_415_1" "roslaunch hebi_demo realsense-camera.launch serial_no:=746112060198 camera:=415_1 --wait"
launcher "rs_camera_415_2" "roslaunch hebi_demo realsense-camera.launch serial_no:=747612060067 camera:=415_2 --wait"

# 5. mocap
echo "\033[94mPlace Optitrack Points to be at initialization position!\n... then, press enter to continue\033[0m"
read -n 1 k <& 1
launcher "mocap" "roslaunch \"mocap_optitrack\" \"mocap.launch\" mocap_config_file:=$(rospack find hebi_demo)/launch/mocap.yaml"
